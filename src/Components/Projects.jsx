    ...
    <div id="projects">
      ...
      <div className="flex flex-wrap m-auto p-5 justify-center">
        ...
        <Project
          img={gym}
          name={"Gym website"}
          url={"https://yash-gym.onrender.com/"}
          details={
            "A gym website with the help of [rapid api,express,react and material-ui]"
          }
        ></Project>
        <Project
          img={hoobank}
        ...
        <Project
          ...
          url={"https://hoobank-site-by-yash.netlify.app/"}
          details={
            "A complete dashboard with the help of [mern stack] fetches data from mongodb"
          }
        ></Project>
        <Project
          img={weather}
          name={"Weather app"}
          url={"https://yash-weather-app.netlify.app/"}
          details={
            "A weather app gives weather forecast information of cities of any country"
          }
        ></Project>
        <Project
          img={gallery}
          name={"E-gallery"}
          url={"https://e-gallery1.onrender.com/"}
          details={
            "An e-gallery where you can save images on the cloud and get the link."
          }
        ></Project>
