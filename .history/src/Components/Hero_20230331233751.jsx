  ...
  return (
    ...
    >
      <motion.div
        ...
        className="flex flex-col justify-center items-center mr-8 p-4  sm:w-1/2 max-w-full font-semibold gap-3 md:ml-10 sm:ml-10 md:p-5 sm:p-0 sm:gap-0  md:gap-0"
      >
