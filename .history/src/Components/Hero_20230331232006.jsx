  ...
  return (
    ...
    >
      <motion.div
        ...
        className="flex flex-col sm:justify-center items-center ml-48  w-1/2 font-semibold gap-3 md:ml-10 sm:ml-10 md:p-5 sm:p-0 sm:gap-0  md:gap-0"
      >
        ...
        <span className="text-[40px]  font-normal text-red-900 font-Lobster ">
