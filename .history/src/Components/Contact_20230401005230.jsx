        ...
        <MDBContainer className="text-center text-md-start mt-5">
          <MDBRow className="mt-3 flex flex-row">
            <MDBCol md="3" lg="4" xl="3" className="mx-auto mb-4">
              ...
              <p>
                "Creating engaging and interactive web applications using
                cutting-edge development tools and designing visually appealing
            ...
            <MDBCol md="3" lg="2" xl="2" className="mx-auto mb-4">
              <h6 className="text-uppercase fw-bold mb-4">Mastery on Stack</h6>
              <p>
                <a href="#!" className="text-reset">
                  React
                </a>
