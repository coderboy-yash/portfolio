  ...
  return (
    <motion.div className="flex flex-col " id="services">
      <motion.div
        ...
        className="w-2/3 flex flex-col gap-3 justify-center m-5 p-10 bg-black border-4 border-yellow-200 rounded-lg text-white"
      >
        <span className="text-[30px] font-Merriweather">
          My awesome{" "}
          <span className="text-[34px] text-yellow-200 font-normal ">
            services
          </span>{" "}
        </span>
      ...
      <div className="flex flex-col sm:flex-row m-auto sm:m-0  h-1/2 justify-center ">
        <Cards
          emoji={heartemoji}
          heading={"Front end"}
          details={
