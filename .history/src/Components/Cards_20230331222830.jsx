...
const Cards = ({ emoji, heading, details, color }) => {
  return (
    <motion.div
      ...
      className=" shadow-xl shadow-yellow-200 bg-red-100 border-slate-800 rounded-lg border-4  w-64 items-center gap-2  ml-20 flex flex-col  m-5 p-2 font-semibold"
    >
