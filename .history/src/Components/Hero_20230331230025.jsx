...
const Hero = () => {
  return (
    <Container
      ...
      className="flex  font-Tangerine font-extrabold w"
      id="home"
    >
      <motion.div
        initial={{ opacity: 0 }}
        ...
        className="flex flex-col justify-center items-center ml-48  w-1/2 font-semibold gap-3 md:ml-10 sm:ml-10 md:p-5 sm:p-0 sm:gap-0  md:gap-0"
      >
        ...
        <span className="text-[40px]  font-extrabold text-red-900 ">
          Full stack developer skilled in various latest skills and technologies
